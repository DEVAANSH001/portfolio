        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-5 text-sm text-muted-foreground">
            <div className="flex items-center gap-2 hover:text-primary transition-colors">
              ...
              <a href="mailto:devaanshdubey2211@gmail.com" className="break-all sm:break-normal">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link href="/Devaansh_Resume.pdf" target="_blank" download>
              <Button
                size="sm"
            ...
            <Link href="https://codolio.com/profile/Devaansh" target="_blank">
              <Button
                variant="outline"
                size="sm"
                className="text-xs sm:text-sm px-3 sm:px-4"
