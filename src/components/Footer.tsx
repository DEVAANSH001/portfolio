      ...
      <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-accent/5 p-2">
        ...
        <div className="relative font-mono text-xs">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="flex space-x-1">
              {[
                {
                  icon: FaGithub,
                  url: "https://github.com/DEVAANSH001",
                  label: "GH",
                },
                {
                  icon: FaLinkedin,
                  url: "https://www.linkedin.com/in/devaanshdubey001/",
                  label: "LI",
                },
                {
                  icon: SiKaggle,
                  url: "https://www.kaggle.com/devaanshdubey",
                  label: "KG",
                },
              ].map((social, i) => (
                <a
          ...
          <div className="flex flex-col items-center justify-center space-y-4 md:items-end">
            {/* <Link
              href="mailto:devaanshdubey2211@gmail.com"
            ...
            >
              ...
              <span className="relative">devaanshdubey2211@gmail.com</span>
            </Link> */}
